...
export default function BrowseScholarships() {
  ...
  useEffect(() => {
    ...
    const hasTrigger = window.sessionStorage.getItem(
    ...
    window.sessionStorage.removeItem(MONEY_RAIN_TRIGGER_KEY);
    setShowMoneyRain(true);

    const cleanup = window.setTimeout(() => setShowMoneyRain(false), 2200);
      ...
      <main className="min-h-screen bg-zinc-950 text-white px-6 py-16">
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center justify-between mb-4">
            <h1 className="text-3xl font-bold">Browse Local Scholarships</h1>
          ...
          <p className="text-zinc-400 mb-12">
            ...
            of Ravalli County. To apply, click the scholarship links and complete
            applications on the organization’s website to ensure the most
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-12">
            ...
            <div className="flex flex-col gap-3">
              ...
              <Link
                href="/browse/schools"
                className="bg-zinc-900 border border-zinc-800 rounded-lg px-4 py-3 text-sm font-semibold text-left text-white transition hover:border-zinc-700 hover:bg-zinc-900"
              >
                Browse School-Specific Scholarships
              </Link>
            </div>
